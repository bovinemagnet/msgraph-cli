...
func (a *App) setupUI() {
	...
	menuItems := []struct {
		...
		{"List Bookings (Org)", 'O', func() { a.handleListRoomBookings(a.organiserEmail) }},
		{"List Bookings (Room)", 'R', func() { a.handleListRoomBookings(a.roomEmail) }},
		{"Subscribe (Org)", 'X', func() { a.handleCreateOneDaySubscription(a.organiserEmail) }},
		{"Subscribe (Room)", 'Y', func() { a.handleCreateOneDaySubscription(a.roomEmail) }},
		{"Create Event (Org)", '1', func() { a.handleCreateEvent(a.organiserEmail) }},
		{"Create Event (Room)", '2', func() { a.handleCreateEvent(a.roomEmail) }},
		{"Delete Event (Org)", '3', func() { a.handleDeleteEvent(a.organiserEmail) }},
		{"Delete Event (Room)", '4', func() { a.handleDeleteEvent(a.roomEmail) }},
		{"Create Subscription (Org)", '5', func() { a.HandleCreateSubscriptions(a.organiserEmail) }},
		{"Create Subscription (Room)", '6', func() { a.HandleCreateSubscriptions(a.roomEmail) }},
		{"Delete Subscription by id", 'D', func() { a.HandleDeleteSubscriptions() }},
		{"Help", 'h', a.handleHelp},
